...
// file needs, once, server-side (workPerms, in lib/perm.js), then pass that
// bundle down as a prop through however many rows or items are on screen.
// Everything below stays a plain, synchronous function that takes the bundle
// instead of `who` — and, critically, this file imports nothing from
// lib/perm.js, since lib/perm.js pulls in Sanity/Google and this file is
// imported by client ('use client') components that cannot bundle that.
