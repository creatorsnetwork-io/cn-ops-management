  ...
  return (
    <>
      ...
      <div className="phones">
        ...
        <div className="ph"><div className="scr"><div className="pt"><span>CN Ops</span><span>9:41</span></div><h4>Feedback</h4><div className="psub">Triage without losing the client wording.</div><div className="mcard"><b>Client change request</b><span>Project, channel and round accounting stay attached</span><div className="feedbackQuote">The exact client comment appears here.</div><div className="mchips"><span className="mchip on">Create revision</span><span className="mchip">Resolve</span></div></div><Link className="mbtn" href="/feedback">Open feedback</Link></div></div>
      </div>
